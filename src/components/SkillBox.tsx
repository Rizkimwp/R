...
const SkillBox: React.FC<SkillBoxProps> = ({ title, imageUrl }) => {
  return (
    <div className="w-32 h-32 bg-black border-2 border-color4 rounded-md shadow-md hover:shadow-xl transition duration-300 hover:scale-105 relative group hover:shadow-abu p-4">
