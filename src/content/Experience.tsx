...
const Experience = () => {
  return (
    <div className="w-screen bg-dark p-10">
      <div className="container-md mx-auto flex flex-col items-center justify-evenly" id="experience">
        <div className="text-center flex flex-col items-center md:w-3/5">
          <div className="flex flex-col md:flex-row items-center justify-center relative">
            ...
            <img src="/logo/rocket.png" alt="Logo" className="w-10 h-10 md:w-24 md:h-24 mb-1   md:mb-0 z-10" />
            <div className="text-xl md:text-5xl font-semibold font-fightree z-10 md:ml-4 text-white">
              <span className="font-extrabold text-white">SPECIALIZED</span> SKILLS
            </div>
          </div>
